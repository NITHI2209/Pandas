...
# It provides easy-to-use tools to work with structured data, especially tables (rows and columns).

# Key points:
# 1)Built on top of Python and NumPy
...
# 2)Data cleaning
# 3)Size mutability
# 4)Reshapning and pivoting of datasets
# 5)Efficient Manipulation and extraction
